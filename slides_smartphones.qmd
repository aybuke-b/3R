...
## Statistiques descriptives (III) {.smaller}

ACP à faire.

## Sélection de variables {.smaller}

Avec 35 prédicteurs, le choix des variables *essentielles* à retenir est important.

*Forward stepwise selection* (**Voir qui a implémenté cette méthode pour le citer**)
...
3. On retient la variable avec la $p-value$ la plus faible.
...
- Cette méthode est donc supposée trouver le meilleur modèle sans avoir besoin de calculer le critère à considérer sur tous les modèles possibles.
