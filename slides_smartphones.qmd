...
Par exemple, le prix moyen d'un smartphone dans l'étude est de 136,35 $, alors qu'on peut se douter que celui qu'on va trouver sera plus important. Note intéressante, l'**écart-type** du prix des smartphones est particulièrement elevé (181), c'est à dire que la dispersion en prix est très importante, ce qui confirme que les smartphones sont des biens hautement différenciés.
...
Boulanger a été scrapé et 435 modèles valides ont été identifiés avec une trentaine de caractéristiques.
