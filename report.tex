...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, breakable, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Hypothèses}, arc=.35mm, leftrule=.75mm, toptitle=1mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, breakable, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Limites}, arc=.35mm, leftrule=.75mm, toptitle=1mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, breakable, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Rappel}, arc=.35mm, leftrule=.75mm, toptitle=1mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, breakable, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Conclusion}, arc=.35mm, leftrule=.75mm, toptitle=1mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, breakable, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Encadrement du web scraping}, arc=.35mm, leftrule=.75mm, toptitle=1mm, opacityback=0]
...
\item
  ...
  haut que le téléphone le plus cher était le \textbf{HONOR V2}, qui
  possède 12 Go de RAM, et non 16. Ce constat, en plus du nombre très
  limité de téléphones disposant de 16 Go de RAM (7), peut expliquer
  pourquoi le prix moyen des téléphones ayant 16 Go de RAM est inférieur
  au prix moyen des téléphones disposant de 12 Go de RAM.
\item
...
\midrule
\cellcolor{gray!10}{backward} & \cellcolor{gray!10}{lm} & \cellcolor{gray!10}{5690.77} & \cellcolor{gray!10}{0.94} & \cellcolor{gray!10}{5800.62} & \cellcolor{gray!10}{0.15} & \cellcolor{gray!10}{0.88} & \cellcolor{gray!10}{164.86}\\
forward & lm & 5701.38 & 0.00 & 5799.02 & 0.33 & 0.87 & 168.06\\
\cellcolor{gray!10}{genetic} & \cellcolor{gray!10}{lm} & \cellcolor{gray!10}{5696.35} & \cellcolor{gray!10}{0.06} & \cellcolor{gray!10}{5798.06} & \cellcolor{gray!10}{0.53} & \cellcolor{gray!10}{0.87} & \cellcolor{gray!10}{166.70}\\
\bottomrule
\end{tabular}
\end{table}
...
\\[-1.8ex] & (1) & (2) & (3)\\ 
\hline \\[-1.8ex] 
 induction & 227.714$^{***}$ (33.261) & 221.537$^{***}$ (33.432) & 220.538$^{***}$ (33.535) \\ 
  ppi &  &  & $-$5.519$^{***}$ (1.633) \\ 
  storage & 0.861$^{***}$ (0.063) & 0.881$^{***}$ (0.063) & 0.902$^{***}$ (0.063) \\ 
  brandGOOGLE & $-$447.142$^{***}$ (71.229) & $-$411.534$^{***}$ (70.863) & $-$415.790$^{***}$ (70.820) \\ 
  brandHONOR & $-$588.143$^{***}$ (70.614) & $-$566.963$^{***}$ (70.150) & $-$549.709$^{***}$ (70.825) \\ 
  brandMOTOROLA & $-$581.432$^{***}$ (48.194) & $-$530.809$^{***}$ (51.794) & $-$520.270$^{***}$ (50.439) \\ 
  brandOPPO & $-$616.180$^{***}$ (80.926) & $-$575.601$^{***}$ (81.764) & $-$568.095$^{***}$ (81.284) \\ 
  brandSAMSUNG & $-$357.460$^{***}$ (61.256) & $-$348.235$^{***}$ (62.540) & $-$340.187$^{***}$ (61.633) \\ 
  brandSONY & $-$470.079$^{***}$ (98.796) & $-$527.406$^{***}$ (98.974) & $-$467.997$^{***}$ (105.271) \\ 
  brandXIAOMI & $-$611.820$^{***}$ (41.851) & $-$610.973$^{***}$ (49.250) & $-$561.572$^{***}$ (43.378) \\ 
  screen\_size &  &  & $-$345.205$^{***}$ (107.762) \\ 
  ram & 26.599$^{***}$ (5.427) & 18.709$^{***}$ (5.891) & 22.944$^{***}$ (5.612) \\ 
  screen\_typeBords incurvés & $-$278.274$^{***}$ (85.107) & $-$270.885$^{***}$ (84.258) & $-$240.422$^{***}$ (82.262) \\ 
  screen\_typePlat & $-$107.643$^{***}$ (37.759) & $-$110.018$^{***}$ (38.859) & $-$85.128$^{**}$ (37.042) \\ 
  screen\_typePliable & 296.204$^{***}$ (53.132) & 262.773$^{***}$ (54.951) & 273.028$^{***}$ (62.761) \\ 
  battery & 0.122$^{***}$ (0.019) & 0.111$^{***}$ (0.019) & 0.123$^{***}$ (0.025) \\ 
  usb\_type\_c & 91.605$^{***}$ (23.788) & 75.257$^{***}$ (24.703) & 92.533$^{***}$ (23.795) \\ 
  made\_inJapon & 412.945$^{**}$ (197.928) & 307.184 (197.473) & 290.559 (199.387) \\ 
  made\_inThaïlande & 532.377$^{***}$ (114.445) & 559.746$^{***}$ (112.966) & 497.403$^{***}$ (114.346) \\ 
  made\_inViêt Nam & $-$20.652 (53.306) & $-$23.122 (52.591) & $-$8.177 (53.081) \\ 
  upgrade\_storage & $-$96.544$^{***}$ (33.858) & $-$104.271$^{***}$ (33.602) & $-$108.501$^{***}$ (33.629) \\ 
  das\_limbs &  & $-$48.570$^{*}$ (25.498) &  \\ 
  mpx\_backward\_cam & 0.504$^{*}$ (0.271) & 0.578$^{**}$ (0.268) &  \\ 
  resolution\_1 & 0.033 (0.021) & 0.891$^{***}$ (0.230) & 0.698$^{***}$ (0.192) \\ 
  resolution\_2 &  & 0.853$^{***}$ (0.226) & 0.660$^{***}$ (0.190) \\ 
  fast\_charging & $-$79.161 (56.183) & $-$80.281 (56.435) &  \\ 
  diagonal\_pixels &  & $-$1.106$^{***}$ (0.302) &  \\ 
  Constant & 27.808 (103.256) & 182.074 (144.126) & 2,114.800$^{***}$ (682.647) \\ 
 \hline \\[-1.8ex] 
Observations & 432 & 432 & 432 \\ 
R$^{2}$ & 0.879 & 0.884 & 0.881 \\ 
Adjusted R$^{2}$ & 0.873 & 0.877 & 0.875 \\ 
Residual Std. Error & 172.721 (df = 409) & 170.057 (df = 406) & 171.531 (df = 408) \\ 
F Statistic & 135.564$^{***}$ (df = 22; 409) & 123.698$^{***}$ (df = 25; 406) & 131.765$^{***}$ (df = 23; 408) \\ 
\hline 
\hline \\[-1.8ex] 
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, breakable, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Difficultés de convergence d'un modèle SFA}, arc=.35mm, leftrule=.75mm, toptitle=1mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, breakable, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Mesure de la multicolinéarité}, arc=.35mm, leftrule=.75mm, toptitle=1mm, opacityback=0]
...
Avec un \emph{VIF} estimé de 252.39, il n'est pas surprenant de
...
\midrule
\cellcolor{gray!10}{(Intercept)} & \cellcolor{gray!10}{4.7458} & \cellcolor{gray!10}{***} & \cellcolor{gray!10}{0.2728}\\
storage & 0.0006 & *** & 0.0001\\
\cellcolor{gray!10}{brandGOOGLE} & \cellcolor{gray!10}{-0.5947} & \cellcolor{gray!10}{***} & \cellcolor{gray!10}{0.0907}\\
brandHONOR & -0.9934 & *** & 0.0959\\
\cellcolor{gray!10}{brandMOTOROLA} & \cellcolor{gray!10}{-0.9844} & \cellcolor{gray!10}{***} & \cellcolor{gray!10}{0.0677}\\
\addlinespace
brandOPPO & -0.9258 & *** & 0.1069\\
\cellcolor{gray!10}{brandSAMSUNG} & \cellcolor{gray!10}{-0.496} & \cellcolor{gray!10}{***} & \cellcolor{gray!10}{0.0914}\\
brandSONY & -0.6402 & *** & 0.1315\\
\cellcolor{gray!10}{brandXIAOMI} & \cellcolor{gray!10}{-1.0341} & \cellcolor{gray!10}{***} & \cellcolor{gray!10}{0.0645}\\
ram & 0.0763 & *** & 0.0071\\
\addlinespace
\cellcolor{gray!10}{inductionTRUE} & \cellcolor{gray!10}{0.2185} & \cellcolor{gray!10}{***} & \cellcolor{gray!10}{0.0435}\\
screen\_size & 0.1326 & *** & 0.0402\\
\cellcolor{gray!10}{screen\_typeBords incurvés} & \cellcolor{gray!10}{-0.0897} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{0.1076}\\
screen\_typePlat & -0.0262 &  & 0.0426\\
\cellcolor{gray!10}{screen\_typePliable} & \cellcolor{gray!10}{0.3778} & \cellcolor{gray!10}{***} & \cellcolor{gray!10}{0.0702}\\
\addlinespace
made\_inJapon & 0.2052 &  & 0.2544\\
\cellcolor{gray!10}{made\_inThaïlande} & \cellcolor{gray!10}{0.6992} & \cellcolor{gray!10}{***} & \cellcolor{gray!10}{0.1472}\\
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, breakable, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Un estimateur différent}, arc=.35mm, leftrule=.75mm, toptitle=1mm, opacityback=0]
...
\midrule
\cellcolor{gray!10}{Samsung Galaxy S22 Ultra} & \cellcolor{gray!10}{0.480} & \cellcolor{gray!10}{8} & \cellcolor{gray!10}{128} & \cellcolor{gray!10}{1310.51 €} & \cellcolor{gray!10}{7.178} & \cellcolor{gray!10}{5.983}\\
...
\cellcolor{gray!10}{Xiaomi 13} & \cellcolor{gray!10}{0.575} & \cellcolor{gray!10}{8} & \cellcolor{gray!10}{256} & \cellcolor{gray!10}{899 €} & \cellcolor{gray!10}{6.801} & \cellcolor{gray!10}{5.896}\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, breakable, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{\textbf{Licence CC BY-NC-SA 4.0} \textbar{}
\faIcon{creative-commons}\faIcon{creative-commons-by}\faIcon{creative-commons-nc}\faIcon{creative-commons-sa}}, arc=.35mm, leftrule=.75mm, toptitle=1mm, opacityback=0]
