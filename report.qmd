...
df |>
    ...
    kbl(caption = "Demo table", booktabs = T) |>
...
df |>
    ...
    kbl(caption = "Demo table2", booktabs = T) |>
    kable_styling(latex_options = c("striped", "hold_position"))

summary(df)
```

relations non linéaire concernant l'ajout de stockage ou ram, à creuser.

peut etre des ggplot de boites à stachmou
...
TODO => ACP, tableaux avec RAM et Storage, etc...
