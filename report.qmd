...
**Résultats** : Les dommages marginaux dus à la pollution augmentent avec le niveau de pollution de l'air et avec le niveau de revenu des ménages. \textcolor{red}{PRECISER DES RESULTATS, des tables, des régressions, la forme fonctionnelle utilisée ici, etc.}

Pour finir, l'approche hédonique a été utilisée empiriquement dans de très nombreux domaines comme l'automobile, l'immobilier, etc. \textcolor{red}{DONNER DES EXEMPLES D'applications ici}
...
TODO: package d'acronyms à mettre en place.
